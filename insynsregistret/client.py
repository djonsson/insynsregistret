...
class Session(object):
    ...
    def search_transactions(self, from_date, to_date):
        url = self.BASE_URL + '/SearchPage.aspx'
    ...
    def search_insiders(self):
        ...
        e, v = self.__get_request_to_setup_asp_fields(url)
        response = self.__session.post(url, data=self.__request_payload(e, v, drop_down='Insyn', from_date='2015-11-18',
                                                                        to_date='2015-12-18'))
    ...
    def search_company(self, company_name=None, org_number=None):
        ...
        url = self.BASE_URL + '/Startpage.aspx?searchtype=0&culture=sv-SE'
